...
export function pickScrap(wx, wy){ for(const sc of state.scraps){ if(Math.hypot(wx-sc.x, wy-sc.y) < 12/state.cam.zoom) return sc; } return null; }

export function pickBuilding(wx, wy){
